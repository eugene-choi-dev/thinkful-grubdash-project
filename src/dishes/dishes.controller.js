...
function hasPrice(req, res, next) {
  ...
  if (!price || price <= 0 || typeof price !== "number") {
    next({
      status: 400,
      message: `Dish must include a valid price, and that price must be an integer greater than 0`,
    });
  }
  next();
}
...
module.exports = {
  ...
  update: [dishExists, hasName, hasDescription, hasPrice, hasImageUrl, idsMatch, update],
  list,
};
